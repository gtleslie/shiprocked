        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-10 pb-10 md:px-12 md:pt-16 md:pb-12 lg:px-16">
          <div className="relative isolate max-w-[1080px] min-h-[11rem] md:min-h-[14rem]">
            <div
              ...
              aria-hidden
            >
              <div className="-ml-6 w-[calc(100%+3rem)] max-w-[min(1280px,98vw)] origin-left select-none -translate-x-[calc(3%+20px)] md:-ml-12 md:w-[calc(100%+5rem)] md:-translate-x-[calc(16%+20px)] lg:-ml-14 lg:w-[calc(100%+6rem)] lg:-translate-x-[calc(18%+20px)]">
                <Image
                  ...
                  className="block h-auto w-full translate-y-[calc(28%+10px)] object-contain object-left-bottom opacity-[0.65] brightness-150 contrast-125 mix-blend-screen [clip-path:inset(36%_0_0_0)]"
                  priority
                />
              </div>
            </div>
