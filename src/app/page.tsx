      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-12 pb-10 md:px-12 md:pt-20 md:pb-12 lg:px-16">
          <div className="relative max-w-[1080px]">
            <div
              className="pointer-events-none relative -ml-6 w-[calc(100%+3rem)] max-w-[min(1280px,98vw)] origin-left mix-blend-screen select-none -translate-x-[3%] md:-ml-12 md:w-[calc(100%+5rem)] md:-translate-x-[16%] lg:-ml-14 lg:w-[calc(100%+6rem)] lg:-translate-x-[18%]"
              aria-hidden
            >
              <Image
                ...
                className="h-auto w-full translate-y-[14%] object-contain object-left-bottom brightness-150 contrast-125 [clip-path:inset(36%_0_0_0)] [margin-bottom:calc(-36%*1080/1920)]"
                priority
              />
            </div>
