        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-12 pb-10 md:px-12 md:pt-20 md:pb-12 lg:px-16">
          <div className="relative isolate max-w-[1080px] min-h-[11rem] md:min-h-[14rem]">
            <div
              ...
              aria-hidden
            >
              <div className="-ml-4 w-[calc(100%+3rem)] max-w-[min(1280px,98vw)] origin-left mix-blend-screen select-none md:-ml-10 md:w-[calc(100%+5rem)] md:-translate-x-[4%] lg:-ml-14 lg:w-[calc(100%+6rem)]">
                <Image
