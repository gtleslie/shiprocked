        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-3 pb-10 max-sm:pt-0 md:px-12 md:pt-8 md:pb-12 lg:px-16 lg:pt-9">
          <div className="relative isolate max-w-[1080px] min-h-[11rem] max-sm:min-h-[10.5rem] md:min-h-[14rem]">
            <div
              ...
              aria-hidden
            >
              <div className="-ml-6 w-[calc(100%+3rem)] max-w-[min(1280px,98vw)] origin-left select-none -translate-x-[calc(3%+20px)] max-sm:-ml-[max(1rem,calc(50%-50vw))] max-sm:w-[100vw] max-sm:max-w-[100vw] max-sm:-translate-x-[58px] max-sm:translate-y-[68px] md:-ml-12 md:w-[calc(100%+5rem)] md:-translate-x-[calc(16%+20px)] lg:-ml-14 lg:w-[calc(100%+6rem)] lg:-translate-x-[calc(18%+20px)]">
                <Image
