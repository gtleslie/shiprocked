    ...
    <PageShell activePage="about">
      <section className="relative isolate">
        ...
        <div
          ...
          aria-hidden
        />
        <div className="relative mx-auto max-w-[1440px] px-4 py-10 md:px-12 md:py-16 lg:px-16 lg:py-20">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 py-10 md:px-12 md:py-14 lg:px-16">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-8 pb-5 md:px-14 md:pt-12 md:pb-7 lg:px-20 lg:pt-14 lg:pb-8">
          <CharactersCarousel
            header={
        ...
        <div className="relative mx-auto max-w-[1440px] px-4 pt-5 pb-8 md:px-14 md:pt-7 md:pb-12 lg:px-20 lg:pt-8 lg:pb-14">
          <CharactersCarousel
            header={
              <h2 className="text-[26px] font-black text-white md:text-[32px]">
