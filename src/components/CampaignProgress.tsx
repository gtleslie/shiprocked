      ...
      <div className="relative overflow-visible pt-[72px] max-sm:pt-[58px] md:pt-[110px]">
        ...
        >
          <Image
            ...
            width={2388}
            height={1668}
            className="absolute top-0 left-1/2 h-full w-full max-w-none -translate-x-1/2 object-contain object-bottom max-sm:scale-[1.06] md:h-[154%] md:w-[132%] md:scale-100 md:object-cover md:object-top"
          />
        </div>
