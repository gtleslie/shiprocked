...
export function CampaignProgress({
  ...
  return (
    <div ref={trackRef} className={className}>
      <div className="relative overflow-visible pt-[72px] max-sm:pt-[30px] md:pt-[110px]">
        <div
          className="campaign-rider pointer-events-none absolute z-[2] h-[78px] w-[104px] overflow-hidden max-sm:h-[92px] max-sm:w-[122px] md:h-[132px] md:w-[220px]"
          style={{ left: `${ride}%` }}
        >
          <Image
            ...
            width={2388}
            height={1668}
            className="absolute top-0 left-1/2 h-full w-full max-w-none -translate-x-1/2 object-contain object-bottom max-sm:translate-y-[16px] max-sm:scale-[1.12] md:h-[154%] md:w-[132%] md:translate-y-0 md:scale-100 md:object-cover md:object-top"
          />
        </div>
