    ...
    <section className="hero-cinematic relative flex flex-col overflow-hidden lg:h-[calc(100dvh-84px-6rem)]">
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1440px] flex-1 flex-col lg:flex-row">
        <div className="relative z-10 flex flex-col justify-center px-4 py-8 md:px-12 md:py-12 lg:flex-1 lg:basis-[42%] lg:px-10 lg:py-16 xl:px-14">
          <div className="w-full max-sm:flex max-sm:justify-start">
            <Logo size="hero" />
          </div>
        </div>

        <div className="hero-visual relative z-10 flex w-full items-center justify-center px-4 pb-8 md:px-10 md:py-16 lg:min-h-0 lg:flex-1 lg:basis-[58%] lg:px-12 lg:py-20">
